...
![Main Menu](/img/general-basics/main-menu.png)

**Practical notes:**

- Use Cancel to exit any flow and return here.
- Use this as your stable starting point between patients.
- If a workflow tile is missing, it is usually a permission/role issue.
